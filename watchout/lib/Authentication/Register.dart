                ...
                onTap: () async {
                  ...
                  if (_role == null || _role == " ") {
                    ...
                    Fluttertoast.showToast(
                        msg: "It is Manadatory to Select Role",
                      ...
                      if (emailValid) {
                        if (nameCont.text != null &&
                          ...
                          FirebaseFirestore.instance
                            ...
                            'name': nameCont.text.toLowerCase().trim(),
                            'pass': passCont.text,
                            'photo':
                            ...
                            prefs.setString(
                                'email', nameCont.text.toLowerCase().trim());
